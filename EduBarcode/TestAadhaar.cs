    ...
    public partial class TestAadhaar : Form
    {
        ...
        public async Task<HttpResponseMessage> ValidateAadhaarInovativeAsync(string bioXML)
        {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.DefaultRequestHeaders.Add("token", "yx0qcnyyc61hcvn99y89umkafp7f7d2l");
                    HttpResponseMessage resp = await client.PostAsync("https://edu.trustview.in/api/exa/eduquitywalkin/uidauth", content).ConfigureAwait(false);
                    return resp;
                }
